...
use NFSeSIMPLISS\Common\Tools as BaseTools;
...
class Tools extends BaseTools
{
    ...
    public function __construct($config, Certificate $cert)
    {
        ...
        $this->xsdpath = $path . '/nfse_v15_07_2020.xsd';
    }
    ...
    public function cancelarNfse($id, $numero, $codigo = self::CANCEL_ERRO_EMISSAO)
    {
        ...
        $pedido = "<CancelarNfseEnvio xmlns=\"http://www.sistema.com.br/Nfse/arquivos/nfse_3.xsd\">"
            . "<Pedido >"
        ...
        $content = str_replace('http://www.sistema.com.br/Nfse/arquivos/nfse_3.xsd',$this->wsobj->msgns,$content);
        $contentmsg = "<CancelarNfse xmlns=\"{$this->wsobj->msgns}\">"
        . $content
        . "</CancelarNfse>";
        return $this->send($contentmsg, $operation);
    }
    ...
    {
        $operation = "GerarNfse";
        $xmlsigned = $this->putPrestadorInNfs($rps);
        $content   = $this->sign($xmlsigned, 'InformacaoNfse', 'Id');
        Validator::isValid($content, $this->xsdpath);

        $content = str_replace('http://www.sistema.com.br/Nfse/arquivos/nfse_3.xsd',$this->wsobj->msgns,$content);
        $contentmsg = "<GerarNfse xmlns=\"{$this->wsobj->msgns}\">"
        . $content
        . "</GerarNfse>";
