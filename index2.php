...
try {
    ...
    $content = file_get_contents('storage/expired_certificate.pfx');
    $password = 'associacao';
    ...
    $std->IntermediarioServico->CpfCnpj = '99999999000191';
    $std->IntermediarioServico->Cpf = '99999999000191';
    ...
    //$xml = $rps->render($std,'2');
    //header('Content-type: text/xml; charset=UTF-8');
    //echo $xml;

    $response = $tools->gerarNfse('1', $std);
